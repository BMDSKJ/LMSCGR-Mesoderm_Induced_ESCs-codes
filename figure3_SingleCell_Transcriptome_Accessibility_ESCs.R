...
# Fig3A
DimPlot(ES_day8, reduction = "umap", group.by = "celltype", label = TRUE, label.size = 2.5, repel = TRUE) + ggtitle("RNA")
DimPlot(ES_day8, reduction = "umap.atac",group.by = "celltype", label = TRUE, label.size = 2.5, repel = TRUE) + ggtitle("ATAC")
DimPlot(ES_day8, reduction = "umap.wnn", group.by = "celltype", label = TRUE, label.size = 2.5, repel = TRUE) + ggtitle("WNN")
